  ...
  return (
    <div className="min-h-[80vh] lg:min-h-screen flex flex-col justify-center py-10 lg:py-10 max-w-2xl mx-auto overflow-hidden">
      <div 
        ...
        className="flex items-center gap-2 border border-[#333] rounded-full px-4 py-1.5 w-fit mb-6 lg:mb-10"
      >
        <Home size={12} className="text-[#999]" />
        <span className="text-[9px] uppercase tracking-[2px] font-medium text-white">Introduce</span>
      </div>

      <h1 
        data-gsap-animate="fade-up" 
        data-gsap-delay="0.2"
        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal leading-[1.1] mb-6 lg:mb-8 tracking-tight"
      >
      ...
      <p 
        data-gsap-animate="fade-up" 
        data-gsap-delay="0.4"
        className="text-[#999] text-sm md:text-base max-w-md leading-relaxed mb-8 lg:mb-14"
      >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-10 sm:gap-0 mt-2">
        <div data-gsap-stagger className="flex gap-10 lg:gap-14">
          <div data-gsap-animate="scale-in">
            ...
            <div className="text-[#666] text-[9px] uppercase tracking-[2px] font-medium">Years in <br/> Admin & Media</div>
          </div>
          <div data-gsap-animate="scale-in" data-gsap-delay="0.1">
            ...
            <div className="text-[#666] text-[9px] uppercase tracking-[2px] font-medium">Projects <br/> Assisted</div>
          </div>
        </div>
        ...
        >
          <svg className="absolute w-full h-full animate-[spin_10s_linear_infinite]" viewBox="0 0 100 100">
            <path
              ...
              fill="none"
            />
            <text className="text-[8px] uppercase tracking-[3px] fill-[#666] group-hover:fill-white transition-colors">
              <textPath href="#circlePath">My Projects • My Projects • </textPath>
            </text>
          </svg>
          <ArrowDown size={24} className="text-white group-hover:translate-y-1 transition-transform" />
        </div>
      </div>
    </div>
  );
