  ...
  return (
    <section id="about" className="lg:min-h-screen flex flex-col justify-center py-10 lg:py-24 max-w-2xl mx-auto overflow-hidden">
      <div data-gsap-animate="fade-right" className="flex items-center gap-2 border border-[#333] rounded-full px-4 py-1.5 w-fit mb-6 lg:mb-10">
        ...
        <span className="text-[9px] uppercase tracking-[2px] font-medium text-white">About</span>
      </div>

      <h2 data-gsap-animate="fade-up" className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-normal leading-tight mb-6 lg:mb-10 tracking-tight">
      ...
      <div data-gsap-stagger className="space-y-6">
        <p className="text-[#999] text-xs md:text-sm leading-loose font-normal">
